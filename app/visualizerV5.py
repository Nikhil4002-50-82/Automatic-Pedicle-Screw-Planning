        ...
        if screw_mesh is not None and show_screw_meshes:
            screw_traces.append(
                go.Mesh3d(
                    ...
                    # intensity=np.linspace(0, 1, len(screw_mesh["x"])),
                    # colorscale=[[0, '#39ff14'], [1, '#0aff9d']],
                    # opacity=0.75,

                    intensity=np.linspace(0, 1, len(screw_mesh["x"])),
                    colorscale=[[0, '#66ff33'], [1, '#00ffcc']],
                    opacity=0.85,
                    lighting=dict(
                        ambient=0.9,
                        diffuse=1.0,
...
# --------------------------------------------------
# Build Visualization (Plotly Figure)
# --------------------------------------------------
...
# --------------------------------------------------
# PyQt6 Window Builder (EXACT same UI as visualizer_unified.py)
# --------------------------------------------------
